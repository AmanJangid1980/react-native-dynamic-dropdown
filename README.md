[<img src="https://github.com/hoaphantn7604/file-upload/blob/master/document/dropdown/react-native-dynamic-dropdown-demo.png">](https://github.com/hoaphantn7604/file-upload/blob/master/document/dropdown/react-native-dynamic-dropdown-demo.png)
...
## Getting started
```js
npm install react-native-dynamic-dropdown --save
```
or

```js
yarn add react-native-dynamic-dropdown
```
### Demo

[<img src="https://github.com/hoaphantn7604/file-upload/blob/master/document/dropdown/react-native-dynamic-dropdown-thumbnal.jpg">](https://youtu.be/FhTDR_Ad_14)
...
```js
  ...
  import { Dropdown } from 'react-native-dynamic-dropdown';
...
```js
  ...
  import { MultiSelect } from 'react-native-dynamic-dropdown';
  import AntDesign from '@expo/vector-icons/AntDesign';
...
```js
  import React, { useState } from 'react';
  import { StyleSheet } from 'react-native';
  import { SelectCountry } from 'react-native-dynamic-dropdown';
